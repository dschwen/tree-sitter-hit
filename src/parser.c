...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [7] = {.count = 1, .reusable = true}, SHIFT(40),
  [9] = {.count = 1, .reusable = true}, SHIFT(47),
  [11] = {.count = 1, .reusable = true}, SHIFT(32),
  [13] = {.count = 1, .reusable = false}, SHIFT(41),
  [15] = {.count = 1, .reusable = true}, SHIFT(33),
  [17] = {.count = 1, .reusable = true}, SHIFT(35),
  [19] = {.count = 1, .reusable = true}, SHIFT(37),
  [21] = {.count = 1, .reusable = true}, REDUCE(aux_sym_top_block_repeat1, 2),
  [23] = {.count = 2, .reusable = false}, REDUCE(aux_sym_top_block_repeat1, 2), SHIFT_REPEAT(41),
  [26] = {.count = 2, .reusable = true}, REDUCE(aux_sym_top_block_repeat1, 2), SHIFT_REPEAT(47),
  [29] = {.count = 1, .reusable = true}, REDUCE(aux_sym_source_file_repeat1, 2),
  [31] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(40),
  [34] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(47),
  [37] = {.count = 1, .reusable = true}, SHIFT(39),
  ...
  [55] = {.count = 1, .reusable = true}, REDUCE(sym_parameter_value, 1),
  [57] = {.count = 1, .reusable = false}, REDUCE(sym_parameter_value, 1),
  [59] = {.count = 1, .reusable = true}, REDUCE(sym__block_head, 3),
  [61] = {.count = 1, .reusable = false}, REDUCE(sym__block_head, 3),
  ...
  [77] = {.count = 1, .reusable = true}, SHIFT(16),
  [79] = {.count = 1, .reusable = false}, SHIFT(16),
  [81] = {.count = 1, .reusable = true}, SHIFT(17),
  [83] = {.count = 1, .reusable = false}, SHIFT(17),
  ...
  [93] = {.count = 1, .reusable = false}, SHIFT(27),
  [95] = {.count = 1, .reusable = true}, REDUCE(sym_parameter_definition, 3),
  [97] = {.count = 1, .reusable = false}, REDUCE(sym_parameter_definition, 3),
  [99] = {.count = 1, .reusable = true}, REDUCE(sym__string, 3),
  [101] = {.count = 1, .reusable = false}, REDUCE(sym__string, 3),
  [103] = {.count = 1, .reusable = true}, REDUCE(sym__string, 2),
  [105] = {.count = 1, .reusable = false}, REDUCE(sym__string, 2),
  [107] = {.count = 1, .reusable = false}, SHIFT(28),
  [109] = {.count = 1, .reusable = false}, REDUCE(aux_sym__string_repeat1, 2),
  [111] = {.count = 2, .reusable = true}, REDUCE(aux_sym__string_repeat1, 2), SHIFT_REPEAT(29),
  [114] = {.count = 2, .reusable = false}, REDUCE(aux_sym__string_repeat1, 2), SHIFT_REPEAT(29),
  [117] = {.count = 1, .reusable = false}, REDUCE(aux_sym__string_repeat2, 2),
  [119] = {.count = 2, .reusable = true}, REDUCE(aux_sym__string_repeat2, 2), SHIFT_REPEAT(30),
  [122] = {.count = 2, .reusable = false}, REDUCE(aux_sym__string_repeat2, 2), SHIFT_REPEAT(30),
  [125] = {.count = 1, .reusable = true}, REDUCE(sym_block, 2),
  [127] = {.count = 1, .reusable = false}, REDUCE(sym_block, 2),
  [129] = {.count = 1, .reusable = true}, REDUCE(sym_block, 3),
  [131] = {.count = 1, .reusable = false}, REDUCE(sym_block, 3),
  [133] = {.count = 1, .reusable = true}, REDUCE(sym_top_block, 3),
  [135] = {.count = 1, .reusable = true}, REDUCE(sym_top_block, 2),
  [137] = {.count = 1, .reusable = true}, SHIFT(42),
  [139] = {.count = 1, .reusable = true}, REDUCE(sym_block_path, 1),
  [141] = {.count = 1, .reusable = true}, SHIFT(13),
  [143] = {.count = 1, .reusable = true}, SHIFT(38),
  [145] = {.count = 1, .reusable = true}, SHIFT(15),
  [147] = {.count = 1, .reusable = true},  ACCEPT_INPUT(),
  [149] = {.count = 1, .reusable = true}, REDUCE(sym_parameter_name, 1),
